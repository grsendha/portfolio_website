...
const ResumeCard = () => {
  return (
    <div class="sm:absolute hidden sm:flex left-10 bottom-20 duration-300  hover:-rotate-0  -rotate-12 group border border-sky-900   overflow-hidden rounded-2xl  h-52 w-72 bg-sky-800 p-5  flex-col items-start gap-4">
      <div class="text-gray-50">
        <span class="font-bold text-3xl">Web</span>
